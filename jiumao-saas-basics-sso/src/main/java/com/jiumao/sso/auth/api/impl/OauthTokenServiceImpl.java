...
package com.jiumao.sso.auth.api.impl;
...
import com.jiumao.sso.auth.api.OauthTokenService;
...
public class OauthTokenServiceImpl extends BaseResultFactory implements OauthTokenService {
	...
	public DefaultOAuth2AccessToken getSuperToken(Map<String, String> parameters,Map<String,Object> userInfos) {
